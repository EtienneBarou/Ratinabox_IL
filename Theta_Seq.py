...
class ThetaSequenceAgent(Agent):
    ...
    default_params = {
        "v_sequence": 5.0,  # sequence speed in reference frame of Agent, ms-1
        "theta_freq": 8.0,  # theta frequency 8 Hz
        "theta_frac": 0.5,  # fraction of theta cycle over which
        "dt": 0.001,
    }
